    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request-> request.requestMatchers("/auth/**", "/public/**",
                                "/employees/**", "/resourcetypes/**").permitAll()
                        .requestMatchers("/admin/**", "/resources/admin/**").hasAnyAuthority("ADMIN")
                        .requestMatchers("/user/**").hasAnyAuthority("USER")
                        .requestMatchers("/adminuser/**", "/resources" , "/resources/register/").hasAnyAuthority("ADMIN", "USER")
